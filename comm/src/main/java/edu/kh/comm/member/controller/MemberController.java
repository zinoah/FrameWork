...
public class MemberController{
	 ...
	 * -> 요청 방식에 따라 요청 처리함
	 * 
	 * ** 메소드 레벨에서 (GET/POST) 방식을 구분하여 매핑할 경우
	...
	public String login(HttpServletRequest req) {
		...
		return "redirect:/"; //sendRedirect 안써도 된다. 이게 redirect 구문임.
	} */
	...
	public String login(@RequestParam("inputEmail") String inputEmail, @RequestParam("inputPw") String inputPw,
						@RequestParam( value ="inputName", required = false, defaultValue = "홍길") String inputName){
	...
	// *** @ModelAttribute 를 이용해서 객체의 값을 직접 담는 경우에 대한 주의 사항 ***
	// -- 반드시 필요한 내용
	// -VO 기본생성자
	// -VO 필드에 대한 Setter 
	@PostMapping("/login")
